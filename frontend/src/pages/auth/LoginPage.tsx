        ...
        <CardContent className="dark">
          ...
          {view === "login" && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button variant="outline" type="button" className="w-full min-h-[44px] relative" disabled>
                ...
                {t("loginWithGoogle")}
                <span className="absolute end-2 top-1/2 -translate-y-1/2 text-[10px] bg-gray-100 text-gray-500 rounded px-1 py-0.5">בקרוב</span>
              </Button>
